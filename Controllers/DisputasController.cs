...
namespace RpgMvc.Controllers
{
    public class DisputasController : Controller
    {
        ...
        public string uriBase = "http://Duardo0127.somee.com/RpgApi/Disputas/";
...
/*---------------DISPUTA COM ARMAS----------------------------------------------------------*/
        ...
        public async Task<ActionResult> IndexAsync()
        {
            try
            {
                ...
                string uriBuscaPersonagens = "http://Duardo0127.somee.com/RpgApi/Personagens/GetAll";
...
/*---------------DISPUTA HABILIDADES----------------------------------------------------------*/
        ...
        public async Task<ActionResult> IndexHabilidadesAsync()
        {
            try
            {
                ...
                string uriBuscaHabilidades = "http://Duardo0127.somee.com/RpgApi/PersonagemHabilidades/GetHabilidades";
...
/*---------------DISPUTA EM GRUPO----------------------------------------------------------*/
        ...
        public async Task<ActionResult> DisputaGeralAsync()
        {
            try
            {
                ...
                string uriDisputa = "http://Duardo0127.somee.com/RpgApi/Disputas/DisputaEmGrupo";
